...
This project is simple cv remake.
...
Download and run. Edit in code editor or if your are pro in notepad.
...
Project Link: [Porject Link](https://github.com/Coding-Err0r/simple-cv.git)
